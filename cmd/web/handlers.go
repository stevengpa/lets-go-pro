...
import (
	...
	"github.com/stevengpa/lets-go-pro/internal/validator"
)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		...
		err := app.render(w, r, http.StatusUnprocessableEntity, "login.tmpl.html", data)
		if err != nil {
			app.serverError(w, r, err)
		}
		return
	...
	app.sessionManager.Put(r.Context(), "authenitcatedUserID", id)
